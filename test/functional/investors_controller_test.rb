...
class InvestorsControllerTest < ActionController::TestCase
  ...
  test "should create investor" do
    assert_difference('Investor.count') do
      post :create, investor: { name: @investor.name, total_cost: @investor.total_cost, total_value: @investor.total_value }
    end
  ...
  test "should update investor" do
    put :update, id: @investor, investor: { name: @investor.name, total_cost: @investor.total_cost, total_value: @investor.total_value }
    assert_redirected_to investor_path(assigns(:investor))
  end
